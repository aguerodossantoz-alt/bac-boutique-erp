...
export function CatalogImportedView() {
  ...
  useEffect(() => {
    void loadCatalogFromDbFirst().catch(() => {});
  }, []);

  async function handleRefreshCatalog() {
    setIsCatalogRefreshing(true);
    setRefreshMessage("Обновляю каталог...");

    try {
      const rows = await loadCatalogFromDbFirst();
      setRefreshMessage(`Каталог обновлён. Товаров: ${rows.length}`);
    } catch (error) {
      console.error("Ошибка обновления каталога:", error);
      setRefreshMessage("Не удалось обновить каталог.");
    } finally {
      ...
      <div className="space-y-6">
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-400">
            Добавьте первый товар через кнопку «Новый товар». После сохранения
            он появится в каталоге и в базе данных.
          </p>
          ...
          <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-emerald-300">
                Источник данных: Prisma Product / API
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                onClick={() => {
                  ...
                  setDraft({
                    ...
                    stock_qty: "0",
                    store:
                      storeFilter === "Все магазины" ? "Магазин 1" : storeFilter,
              ...
              <button
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-3 text-sm text-white transition hover:bg-white/[0.08] disabled:cursor-not-allowed disabled:opacity-50"
              >
                {isCatalogRefreshing ? "Обновляю..." : "Обновить каталог"}
              </button>
            </div>
          </div>
          ...
          {refreshMessage && (
            <div
              className={`mt-3 rounded-2xl border p-4 text-sm ${
                refreshMessage.startsWith("Не удалось")
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateDraft("image_url", event.target.value)
                  }
                  className="w-full rounded-2xl border border-white/10 bg-[#090909] px-4 py-3 text-sm text-white outline-none"
                  placeholder="https://..."
                />
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateDraft("promo_price", event.target.value)
                  }
                  className="w-full rounded-2xl border border-white/10 bg-[#090909] px-4 py-3 text-sm text-white outline-none"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateDraft("retail_price", event.target.value)
                  }
                  className="w-full rounded-2xl border border-white/10 bg-[#090909] px-4 py-3 text-sm text-white outline-none"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateDraft("purchase_price", event.target.value)
                  }
                  className="w-full rounded-2xl border border-white/10 bg-[#090909] px-4 py-3 text-sm text-white outline-none"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateDraft("stock_qty", event.target.value)
                  }
                  className="w-full rounded-2xl border border-white/10 bg-[#090909] px-4 py-3 text-sm text-white outline-none"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(event) =>
                    updateDraft("item_status", event.target.value)
                  }
                  className="w-full rounded-2xl border border-white/10 bg-[#090909] px-4 py-3 text-sm text-white outline-none"
                >
